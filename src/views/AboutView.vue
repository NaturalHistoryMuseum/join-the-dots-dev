  ...
  <div class="main-page">
    <div class="main-header">
      ...
      <p>
        ...
        was developed by the Smithsonian National Museum of Natural History in
        2009. Join the Dots quantifies collections and captures information
      ...
      <p>
        ...
        implementation of new collection management systems and methodologies is
        integral to this ongoing duty of care. The NHM strategy crosses
        disciplines, and integrates research agendas with public engagement
        outputs. Capturing the state of collections items is necessary for
        effective resource planning across the Museum. The design of Join the
        Dots reflects the often holistic nature of curation and collections
