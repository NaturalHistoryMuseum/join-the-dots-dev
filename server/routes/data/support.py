...
def submit_issue():
    ...
    db.session.commit()
    return jsonify({'message': 'Issue submitted successfully', 'success': True}), 200
...
def update_guidance():
    ...
    db.session.commit()
    return jsonify({'message': 'Guidance updated successfully', 'success': True}), 200
...
def add_change_log():
    ...
    db.session.commit()
    return jsonify({'message': 'Change log added successfully', 'success': True}), 200
...
def update_change_log():
    ...
    db.session.commit()
    return jsonify({'message': 'Change log updated successfully', 'success': True}), 200
...
def add_enhancements():
    ...
    db.session.commit()
    return jsonify({'message': 'Enhancement added successfully', 'success': True}), 200
